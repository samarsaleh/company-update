...
<html>
    ...
    <body>
        ...
        <div id="show-degree" class="content scaffold-show" role="main">
            ...
            <f:display bean="degree" />
            <g:form resource="${this.degree}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.degree}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
