...
<html>
    ...
    <body>
        ...
        <div id="show-skill" class="content scaffold-show" role="main">
            ...
            <f:display bean="skill" />
            <g:form resource="${this.skill}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.skill}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
