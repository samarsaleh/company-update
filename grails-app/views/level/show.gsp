...
<html>
    ...
    <body>
        ...
        <div id="show-level" class="content scaffold-show" role="main">
            ...
            <f:display bean="level" />
            <g:form resource="${this.level}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.level}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
