...
<html>
    ...
    <body>
        ...
        <div id="show-university" class="content scaffold-show" role="main">
            ...
            <f:display bean="university" />
            <g:form resource="${this.university}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.university}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
