...
<html>
    ...
    <body>
        ...
        <div id="show-education" class="content scaffold-show" role="main">
            ...
            <f:display bean="education" />
            <g:form resource="${this.education}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.education}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
