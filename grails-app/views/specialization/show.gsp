...
<html>
    ...
    <body>
        ...
        <div id="show-specialization" class="content scaffold-show" role="main">
            ...
            <f:display bean="specialization" />
            <g:form resource="${this.specialization}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.specialization}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
