...
<html>
    ...
    <body>
        <a href="#edit-specialization" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-specialization" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.specialization}" method="PUT">
                <g:hiddenField name="version" value="${this.specialization?.version}" />
                <fieldset class="form">
                    <f:all bean="specialization"/>
                </fieldset>
