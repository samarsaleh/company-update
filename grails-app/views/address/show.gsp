...
%{--            this part is the main --}%
              ...
              <f:display bean="address"  />
           %{-- <form class="embedded address">

                <f:text bean="address" property="town.townName"/>
                <f:text bean="address" property="city.cityName"/>
--}%%{--                <f:text bean="address" property="street"/>--}%%{--
--}%%{--                <f:text bean="address" property="type"/>--}%%{--
                <f:text bean="address" property="person.firstName"/>
            </form>
--}%
